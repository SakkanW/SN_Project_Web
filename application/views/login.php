...
<div id="page-wrapper">
			<div class="main-page login-page ">
				...
				<div class="widget-shadow">
					<div class="login-top">
						<h4 class="serif">ยินดีต้อนรับ <br> ยังไม่ได้เป็นสมาชิกใช่ไหม? <a href="<?php echo site_url('register'); ?>">  กรุณาสมัคร »</a> </h4>
					</div>
                ...
                ?>
						<form method="post" action="<?php echo site_url('login/validation'); ?>">
                            ...
                            <span class="text-danger"><?php echo form_error('user_password'); ?></span>
							<input type="submit" name="Sign In" class ="serif"value="ลงชื่อเข้าใช้">
							<div class="forgot-grid">
								<!-- <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Remember me</label> -->
								<!-- <div class="forgot">
									<a href="<?php echo site_url('forgetpassword/forget'); ?>">ลืมรหัสผ่าน?</a>
								</div> -->
